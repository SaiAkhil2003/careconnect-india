...
The recipient phone must join the Twilio WhatsApp Sandbox before it can receive sandbox messages. Production WhatsApp messaging may require approved templates and a verified WhatsApp Business sender.
